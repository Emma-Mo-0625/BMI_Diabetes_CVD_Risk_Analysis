***********************************************************
*  Study:             Impact of BMI on Diabetes and Cardiovascular Disease Risk
*  Program:           Midterm Project.sas
*  Created by:        Emma Mo, Emily Chiang
*  Date Created:      10/9/24
*  Description:       Merge dataset, clean data, create Tables and Graphs, perform hypothesis testing and logistic regression
*
*
*  Input files:       diabetes_binary_5050split_health_indicators_BRFSS2015.csv, heart_disease_health_indicators_BRFSS2015.csv
*  Output files:      
*
*  Other Comments:    None    
*
...
*  Modified by:          Shengge Cheng, Junlian Cao
*  Date Modified:        31OCT2024
*  Reason Modified:      describe changes made
*
**********************************************************
* Copyright  .
* All rights reserved.
...
proc proc import datafile="/home/u64041732/Midterm/diabetes_binary_5050split_health_indicators_BRFSS2015.csv"
    out=diabetes
    dbms=csv
    replace;
    getnames=yes;
